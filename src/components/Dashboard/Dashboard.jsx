                        ...
                        <div className={`${styles.card} card h-100`}>
                            <div className="row g-0">
                                <div className="col-md-4">
                                    <img src="https://gravatar.com/avatar/21396bf8a2c260311eaca86416ef5db7?s=400&d=mp&r=x" className="img-fluid p-3 rounded-circle" alt="image" />
                                </div>
